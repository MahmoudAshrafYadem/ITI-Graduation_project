...
Large Language Models (LLMs) are deep neural networks trained on massive textual datasets to predict the next token in a sequence \cite{goodfellow2016}.
