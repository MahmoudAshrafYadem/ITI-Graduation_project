...
\begin{figure}[htbp]
    ...
    \caption{Polarity-aware interval delta bar chart. }
...
\begin{table}[H] % [H] forces the table to stay directly under the section heading
    \centering
